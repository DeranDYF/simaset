...
class AuthController extends Controller
{
    ...
    public function register()
    {
        ...
        $this->data['format_template'] = [
            ...
            "title" => "Tambah User | Sistem Monitoring Project",
            "head_title" => " Tambah User",
        ...
        $query = $this->data['auth_groups'] = $query->getResult();
        return view('register/register', $this->data);
        ...
        // return $this->_render($this->config->views['register'],['title' => 'Tambah User | Sistem Monitoring Project', 'head_title' => 'Tambah User'], ['config' => $this->config]);
        return $this->_render($this->config->views, ['config' => $this->config]);
    }
